use crate::{
    Access, Buffer, BufferDesc, BufferUsage, CopyBufferToImageDesc, Error, Extent3d, Format, Frame,
...
impl Frame {
    ...
    pub fn upload_texture_2d(
        ...
        self.copy_buffer_to_image(
            ...
            &staging,
            &image,
            ImageCopyRegion::whole_2d(desc.width, desc.height),
        )?;
        self.add_pass(PassDesc {
        ...
        self.transient_buffers.push(staging);
        Ok(image)
    }
}
